...
## User Input ##############################################################################
pset_name       = 'dimudipi_cfg.py'
request_name    = 'UPCDiMu_UPCReco'
channel         = 'Psi2StoJPsiDiMu'
...
output_pd       = 'PbPb2024'
output_dir      = '/store/group/phys_heavyions/dyano/Run2024/Psi2s_data/HI1/%s' %  request_name
...
config.Data.inputDataset = '/HIForward1/HIRun2024A-PromptReco-v1/AOD'
