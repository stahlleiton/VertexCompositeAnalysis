...
config.JobType.psetName = '../VCTree_PbPb2025_UPCDiKa_UPCReco_cfg.py'
config.JobType.maxMemoryMB = 2500
config.JobType.maxJobRuntimeMin = 720
config.JobType.numCores = 1
config.section_('Data')
config.Data.outLFNDirBase = f'/store/group/phys_heavyions/{REPLACE_WITH_USERNAME}/CERN/PbPb2025/ParticleAnalyzer/' + date+'/DATA/'
...
for i in range(0,24):
    config.General.requestName = f'ParticleAnalyzer_DiKa_HIForward{i}_HIRun2025A_'+date
    config.Data.inputDataset = f'/HIForward{i}/HIRun2025A-PromptReco-v1/MINIAOD'
